...
import com.xiaoma.schedule.common.Result;
import com.xiaoma.schedule.common.ResultCodeEnum;
import com.xiaoma.schedule.pojo.SysUser;
import com.xiaoma.schedule.service.SysUserService;
import com.xiaoma.schedule.service.impl.SysUserServiceImpl;
import com.xiaoma.schedule.util.MD5Util;
import com.xiaoma.schedule.util.WebUtil;
...
public class SysUserController extends BaseController {
    ...
    /**
     * 接受用户注册请求的业务处理方法（接口 不知java中的interface，是业务接口）
     * @param req
     * @param resp
     * @throws ServletException
     * @throws IOException
    ...
    protected void regist(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String userPwd = req.getParameter("userPwd");
        //2 调用服务层方法，完成注册功能
            //将参数放入一个SysUser对象中，再调用regist方法传入
